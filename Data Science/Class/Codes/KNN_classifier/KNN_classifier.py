...
wbcd = pd.read_csv(r"C:\Users\Naveen Kumar\Desktop\Data Science\Class\Datasets\wbcd.csv")
...
wbcd.diagnosis.value_counts() / len(wbcd.diagnosis)  # values in percentages
