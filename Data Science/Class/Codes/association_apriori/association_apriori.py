...
groceries = []
with open(r"C:\Users\Naveen Kumar\Desktop\Data Science\Class\Datasets\groceries.csv") as f: #open text files
    groceries = f.read()
...
### Elemantary Analysis ###
all_groceries_list = [i for item in groceries_list for i in item] #extracting all items
