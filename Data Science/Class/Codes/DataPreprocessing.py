...
data = pd.read_csv("C:/Users/Naveen Kumar/Desktop/Data Science/Class/Datasets/ethnic diversity.csv")
data.dtypes

'''
EmpID is Integer - As Python automatically identify the data types by
interpreting the values. 
As the data for EmpID is numeric Python detects the values as int64.

From measurement levels prespective the EmpID is a Nominal data as it is an 
identity for each employee.

If we have to alter the data type which is defined by Python then we can use 
astype() function
...
# For practice:
# Convert data types of coloumns from:
...
data = pd.read_csv("C:/Users/Naveen Kumar/Desktop/Data Science/Class/Datasets/mtcars.csv")
...
df = pd.read_csv("C:/Users/Naveen Kumar/Desktop/Data Science/Class/Datasets/ethnic diversity.csv")
df.dtypes
...
df = pd.read_csv(r"C:\Users\Naveen Kumar\Desktop\Data Science\Class\Datasets\modified ethnic.csv") # for doing modifications
...
df = pd.read_csv(r"C:\Users\Naveen Kumar\Desktop\Data Science\Class\Datasets\ethnic diversity.csv")
...
df.drop(['Employee_Name', 'EmpID', 'Zip'], axis = 1, inplace =)
...
education = pd.read_csv(r"C:\Users\Naveen Kumar\Desktop\Data Science\Class\Datasets\education.csv")
