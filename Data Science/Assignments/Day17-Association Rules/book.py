# -*- coding: utf-8 -*-
"""
Created on Tue Oct 11 13:47:51 2022
...
books = pd.read_csv(r"C:\Users\Naveen Kumar\Desktop\Data Science\Assignments\Day17-Association Rules\book.csv")
...
frequent_itemsets = apriori(books, min_support = 0.0075, max_len = 4, use_colnames = True) #len no of items in combo
